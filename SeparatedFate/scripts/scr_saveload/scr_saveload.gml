function saveGame(_slot){
	...
	ini_write_real(_slot, "Potion Stash", global.potionStash);
	...
	ini_write_real(_slot, "Kassius Dialogue", global.kassius_dialogue);
	...
	show_debug_message("Potion Stash: " + string(global.potionStash));
	show_debug_message("Potion Life Qtd: " + string(global.lifePotionQtd));
	show_debug_message("Potion Aura Qtd: "  + string(global.auraPotionQtd));
	show_debug_message("Potion Spell Qtd: "  + string(global.spellPotionQtd));
	show_debug_message("Potion Damage Qtd: " + string(global.damagePotionQtd));
...
function loadGame(_slot){
	...
	global.potionStash = ini_read_real(_slot, "Potion Stash", 0);
	...
	global.kassius_dialogue = ini_read_real(_slot, "Kassius Dialogue", 0);
