...
function saveGame(){
	...
	//ini_write_string("savegame", "state", global.bossState);
	ini_write_real("savegame", "state", global.bossState);
...
function loadGame(){
	...
	//global.bossState = ini_read_string("savegame", "state", 0);
	
	global.bossState = ini_read_real("savegame", "state", 0);
